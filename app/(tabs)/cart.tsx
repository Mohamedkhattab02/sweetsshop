...
const styles = StyleSheet.create({
  ...
  cartScroll: { flex: 1 },
  content: { paddingHorizontal: 20, paddingTop: 9, gap: 18 },
  desktopContent: { width: '100%', maxWidth: 760, alignSelf: 'center', paddingHorizontal: 32, paddingTop: 24 },
  ...
  emptyTitle: { color: colors.ink, fontSize: 22, fontWeight: '800', textAlign: 'center' },
  emptyText: { color: colors.inkSoft, fontSize: 14, lineHeight: 20, textAlign: 'center', maxWidth: 280 },
  primaryButton: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: colors.coral, borderRadius: 14, paddingHorizontal: 16, paddingVertical: 13, marginTop: 7 },
  ...
  lines: { gap: 11 },
  line: { backgroundColor: colors.white, borderRadius: 21, padding: 10, flexDirection: 'row', gap: 12, ...shadow.card },
  thumb: { width: 82, height: 92, borderRadius: 16, backgroundColor: colors.sage },
  ...
  lineName: { color: colors.ink, fontSize: 14, lineHeight: 19, fontWeight: '800' },
  lineMeta: { color: colors.inkSoft, fontSize: 10 },
  ...
  linePrice: { color: colors.coralDark, fontSize: 15, fontWeight: '800' },
  ...
  quantity: { color: colors.ink, fontSize: 13, fontWeight: '800', minWidth: 14, textAlign: 'center' },
  noteCard: { flexDirection: 'row', alignItems: 'center', gap: 10, padding: 14, borderRadius: 19, backgroundColor: colors.cream },
  ...
  noteText: { color: colors.inkSoft, fontSize: 11, lineHeight: 16 },
  checkoutBar: { position: 'absolute', left: 0, right: 0, bottom: 0, paddingTop: 15, backgroundColor: 'rgba(251,250,247,0.97)', borderTopWidth: 1, borderTopColor: colors.line },
  checkoutBarInner: { width: '100%', paddingHorizontal: 20, gap: 11 },
  mobileSummary: { gap: 11 },
  summaryRail: { width: 360, padding: 28, borderLeftWidth: 1, borderLeftColor: colors.line, backgroundColor: colors.white },
  desktopSummary: { backgroundColor: colors.cream, borderRadius: 25, padding: 20, gap: 18, borderWidth: 1, borderColor: '#F0D8CE', ...shadow.card },
  summaryKicker: { color: colors.coralDark, fontSize: 9, fontWeight: '900', letterSpacing: 1.4 },
  summaryTitle: { color: colors.ink, fontFamily: 'Georgia', fontSize: 24, fontWeight: '700', marginTop: 4 },
  ...
  promiseText: { color: colors.inkSoft, fontSize: 10, flex: 1 },
  totalRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  totalLabel: { color: colors.ink, fontSize: 13, fontWeight: '700' },
  totalHint: { color: colors.inkSoft, fontSize: 10, marginTop: 2 },
  total: { color: colors.ink, fontSize: 22, fontWeight: '900' },
  checkoutButton: { height: 52, borderRadius: 17, backgroundColor: colors.ink, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10 },
