...
const styles = StyleSheet.create({
  ...
  welcomeCard: { flexDirection: 'row', alignItems: 'center', gap: 13, backgroundColor: colors.ink, borderRadius: 24, padding: 17 },
  welcomeCardDesktop: { flex: 0.8, minHeight: 178, borderRadius: 27, padding: 24 },
  ...
  welcomeKicker: { color: colors.gold, fontSize: 9, fontWeight: '900', letterSpacing: 1.4 },
  welcomeTitle: { color: colors.white, fontSize: 18, fontWeight: '800' },
  welcomeText: { color: '#B8C9C0', fontSize: 11, lineHeight: 16 },
  locationCard: { flex: 1.2, backgroundColor: colors.white, borderRadius: 22, padding: 15, gap: 12, ...shadow.card },
  ...
  cardSub: { color: colors.inkSoft, fontSize: 10, lineHeight: 15 },
  ...
  liveText: { color: colors.inkSoft, fontSize: 9, fontWeight: '900' },
  liveTextActive: { color: '#247843' },
  locationButton: { height: 40, borderRadius: 13, backgroundColor: colors.sage, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 },
  locationButtonText: { color: colors.ink, fontSize: 11, fontWeight: '800' },
  arrow: { transform: [{ rotate: '-90deg' }] },
  coordinates: { color: colors.inkSoft, fontSize: 10, textAlign: 'center' },
  section: { gap: 11 },
  sectionHeader: { flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between' },
  sectionKicker: { color: colors.coralDark, fontSize: 9, fontWeight: '900', letterSpacing: 1.4, marginBottom: 4 },
  sectionTitle: { color: colors.ink, fontSize: 21, fontWeight: '800', letterSpacing: -0.5 },
  sectionCount: { color: colors.inkSoft, fontSize: 10, paddingBottom: 3 },
  sectionList: { gap: 11 },
  deliveryCard: { backgroundColor: colors.white, borderRadius: 21, padding: 15, gap: 12 },
  ...
  deliveryReference: { color: colors.ink, fontSize: 14, fontWeight: '900' },
  deliveryCustomer: { color: colors.inkSoft, fontSize: 10 },
  deliveryTotal: { color: colors.coralDark, fontSize: 13, fontWeight: '900' },
  addressRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 7, backgroundColor: colors.cloud, borderRadius: 12, padding: 10 },
  addressText: { flex: 1, color: colors.ink, fontSize: 11, lineHeight: 16 },
  ...
  mapsButton: { height: 42, borderRadius: 13, backgroundColor: colors.coral, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7 },
  mapsButtonText: { color: colors.white, fontSize: 11, fontWeight: '800' },
  ...
  claimText: { color: colors.white, fontSize: 11, fontWeight: '800' },
  ...
  advanceText: { color: colors.ink, fontSize: 11, fontWeight: '800' },
  ...
  emptyText: { color: colors.inkSoft, fontSize: 11, lineHeight: 17, textAlign: 'center', maxWidth: 280 },
});
