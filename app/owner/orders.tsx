...
const styles = StyleSheet.create({
  ...
  flowSummary: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.white, borderRadius: 16, borderWidth: 1, borderColor: colors.line, padding: 14, ...shadow.card },
  ...
  flowValue: { color: colors.ink, fontFamily: fonts.extraBold, fontSize: 18 },
  flowLabel: { color: colors.inkSoft, fontFamily: fonts.medium, fontSize: 9, marginTop: 1 },
  ...
  filterText: { color: colors.inkSoft, fontFamily: fonts.semibold, fontSize: 11 },
  filterTextActive: { color: colors.white },
  list: { gap: 11 },
  orderCard: { backgroundColor: colors.white, borderRadius: 16, borderWidth: 1, borderColor: colors.line, padding: 15, gap: 13 },
  orderPress: { gap: 13 },
  orderTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', gap: 10 },
  orderCopy: { flex: 1, gap: 3 },
  customer: { color: colors.ink, fontFamily: fonts.bold, fontSize: 15 },
  reference: { color: colors.inkSoft, fontFamily: fonts.medium, fontSize: 10 },
  statusPill: { borderRadius: radii.pill, paddingHorizontal: 9, paddingVertical: 6, maxWidth: 110 },
  statusText: { fontFamily: fonts.bold, fontSize: 9, textAlign: 'center' },
  detailsRow: { flexDirection: 'row', alignItems: 'center', gap: 9, borderTopWidth: 1, borderTopColor: colors.line, paddingTop: 11 },
  items: { color: colors.inkSoft, fontFamily: fonts.medium, fontSize: 11, flex: 1 },
  ...
  fulfillmentText: { color: colors.inkSoft, fontFamily: fonts.medium, fontSize: 10, flex: 1 },
  ...
  acceptText: { color: colors.white, fontFamily: fonts.bold, fontSize: 11 },
  ...
  declineText: { color: colors.coralDark, fontFamily: fonts.bold, fontSize: 11 },
  ...
  nextText: { color: colors.ink, fontFamily: fonts.bold, fontSize: 11 },
  ...
  emptyText: { color: colors.inkSoft, fontFamily: fonts.medium, fontSize: 12, lineHeight: 18, textAlign: 'center', maxWidth: 290 },
});
